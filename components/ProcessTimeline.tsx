...
const steps = [
  {
    number: "01",
    title: "ICP Definition & Qualification Engine Training",
    description:
      "We work closely with you to define your ideal customer profile down to firmographic, technographic, and behavioural signals. We then train the Qualification Engine specifically on your ICP and offer.",
  },
  {
    number: "02",
    title: "Lead List Building & Verification",
    description:
      "We scrape leads matching your ICP across multiple data sources, cross-reference them, and double-verify every email address before anything enters the Qualification Engine. Clean data is non-negotiable.",
  },
  {
    number: "03",
    title: "AI Qualification & Deep Research",
    description:
      "The Qualification Engine researches each prospect across multiple sources, detects trigger events relevant to your offer, and qualifies or disqualifies them against your ICP. Only genuinely qualified leads move forward.",
  },
  {
    number: "04",
